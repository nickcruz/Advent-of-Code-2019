...
class Day5 {
    ...
    /** @return The diagnostic code of the program. */
    fun runTestDiagnosticProgram(): Int {
        val computer = IntCodeComputer(TEST_DIAGNOSTIC_PROGRAM)
        val results = computer.run(listOf(PREPARED_INPUT))
        return results[INDEX_DIAGNOSTIC_CODE]
    }

    companion object {
        private const val PREPARED_INPUT = 1
